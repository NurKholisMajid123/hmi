...
// Level: 1=Admin, 2=Ketua Umum, 3=Sekretaris/Bendahara, 4=Kabid, 5=Anggota
...
// Middleware untuk pengurus inti (Admin, Ketua, Sekretaris, Bendahara)
const isPengurus = (req, res, next) => {
    ...
    // Level 1, 2, 3 adalah pengurus inti
...
// Middleware untuk logging activity (opsional)
...
// Middleware untuk mencegah cache pada halaman yang butuh auth
